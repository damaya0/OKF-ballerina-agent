...
final ai:SystemPrompt SYSTEM_PROMPT = {
    ...
    instructions:
        ...
        "- Use the open_concept tool to open exactly one concept at a time -- copy the link/id verbatim " +
        "from the markdown you are currently looking at (e.g. '/datasets/index.md', '/tables/users.md').\n" +
